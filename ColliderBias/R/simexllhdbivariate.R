...
#'
#' @param pars A vector of two elements including slope of the simple linear regression and ratio of the sampling variance to the variance of the true predictors, on the log scale.
